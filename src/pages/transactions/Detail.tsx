...
export default function SendToken() {
    ...
    const createTx = async () => {
        ...
        const psbt = Psbt.fromHex(psbtHex!, { network: networks.testnet })
        ...
        const _psbt = Psbt.fromHex(_psbtHex!, { network: networks.testnet })

        wallet.addDummySigs(_psbt)
            ...
            <div className="flex min-h-screen flex-col text-white">
                ...
                <main className="flex flex-grow p-6">
                    <div className="mr-6 h-[780px] w-[368px] flex-1 rounded-lg bg-[#101111] p-6">
                        ...
                        {txid ? <a target="_blank" className="text-white underline mt-2" href={`https://mempool.space/zh/testnet/tx/${txid}`}>view on mempool</a> : <div className="space-y-4">
